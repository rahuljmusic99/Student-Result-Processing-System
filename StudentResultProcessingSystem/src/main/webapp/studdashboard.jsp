...
<!-----------------------------------------------------------Profile----------------------------------------------------------------------------->                         
            ...
            <div class="protab1">
                <div class="inner__protab1">
                    ...
                    <div class="inputs">
                        <label>Name</label>
                        <input class="int" type="text" value="<%=request.getSession(false).getAttribute("studentName")%>" readonly>
                        <label>Phone</label>
                        <input class="int" value="<%=request.getSession(false).getAttribute("studentPhone")%>"  readonly>
                        <label>Email</label>
                        <input class="int" type="email" value="<%=request.getSession(false).getAttribute("studentEmail")%>"  readonly>
                        <label>Password</label>
                        <div class="i"><i class="fa-solid fa-eye-slash" id="show-password" onclick="toggle()"></i></div>
                        <input class="int" id="password" type="password" value="<%=request.getSession(false).getAttribute("studentPassword")%>"  readonly>
